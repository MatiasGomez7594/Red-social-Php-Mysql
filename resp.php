<div class="respuestas">
    <form id="responder<?php echo $id_comentario?>comentario" class="form-responder" >
        ...
        type="text" name="respuesta" placeholder="Escribe una respuesta..." autocomplete="off"
...
include("mostrar_respuestas.php");
if($respuestas){
    ?>
    <?php 
    while($row=$respuestas->fetch_array()){
        ...
        <div class="respuesta">
            ...
            <div class="respuesta-opciones">
                <i class="input-like fas fa-thumbs-up" onclick="guardar_like('like',<?php echo $id_respuesta?>,'<?php echo $tipo_publicacion?>',<?php echo $id_usuario?>,<?php echo $id_emisor?>,<?php echo $id_post?>)"></i>
                ...
                <i class="input-unlike fas fa-thumbs-down" onclick="guardar_like('unlike',<?php echo $id_respuesta?>,'<?php echo $tipo_publicacion?>',<?php echo $id_usuario?>,<?php echo $id_emisor?>,<?php echo $id_post?>)"></i>
            ...
            <div class="form-responder" id="<?php echo 'responder'.$id_respuesta.'respuesta'?>">
                <label for="input-comentar"<?php echo $id_respuesta.'respuesta'?>>
                    <img class="foto-perfil" src="<?php 
                    $id_foto_buscada = $id_usuario;
                    include("ver_foto_perfil.php");
                    echo $foto;?>" alt="foto-perfil"
                    >
                    <?php //echo $id_comentario.$id_respuesta.$id_usuario;?>
                </label>
                
                <input type="hidden" name="id_comentario" id="id-comentario<?php ?>" value="<?php echo $id_comentario;?>">
                <input type="hidden" name="id_receptor" id="id-receptor<?php echo $id_respuesta.'respuesta';?>">                    
                <input type="hidden" name="id_usuario" value="<?php echo $id_usuario;?>">
                <input type="text" class="input-responder" placeholder="Escribe una respuesta" 
                name="respuesta" id="input-responder<?php echo $id_respuesta.'respuesta'?>" autocomplete="off"
