...
$mis_publicaciones = "SELECT idPublicacion,idUsuario,contenido,arch_adjunto,fecha_publicacion
 FROM publicaciones WHERE idUsuario = '$id_usuario' ORDER BY fecha_publicacion DESC";
...
if(mysqli_num_rows($todas_mis_publicaciones)>0){
    while($fila=mysqli_fetch_array($publicaciones)){
        $id_usuario_pub = $fila['idUsuario'];
        echo $id_usuario_pub;
        $id_publicacion = $fila['idPublicacion'];
...
<div class="post" id="<?php echo "publicacion".$id_publicacion?>">
            ...
            <div class="post-options">
                <i class="input-like fas fa-thumbs-up" onclick="guardar_like('like',<?php echo $id_publicacion?>,'<?php echo $tipo_publicacion?>',<?php echo $id_usuario?>,<?php echo $id_usuario?>,<?php echo $id_publicacion?>)"></i>
                ...
                ?>
                    ...
                    <i class="input-unlike fas fa-thumbs-down" onclick="guardar_like('unlike',<?php echo $id_publicacion?>,'<?php echo $tipo_publicacion?>',<?php echo $id_usuario?>,<?php echo $id_usuario?>,<?php echo $id_publicacion?>)"></i>
            ...
            <div class="post-coments">
                ...
                <div id="form-comentar<?php echo $id_publicacion?>" class="form-comentar" >
                    ...
                    onkeypress="comentar(<?php echo $id_publicacion;?>,<?php echo $id_usuario;?>,<?php echo $id_usuario;?>)">
                </div>
            </div>
        </div>
        <script>
